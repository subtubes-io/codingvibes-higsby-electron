 ...
 * 
 * This script automates the complete build process for the extension:
...
try {
    ...
    const zipPath = path.join(__dirname, '../hello-world-extension-ts.zip');
    if (fs.existsSync(zipPath)) {
        ...
        console.log(`   📄 File: hello-world-extension-ts.zip`);
